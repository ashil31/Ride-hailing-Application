...
const CaptainLogin = () => {
  ...
  return (
    <div className="p-6 flex flex-col justify-between h-screen">
      ...
      <div className="pt-4">
        <Link to="/login" className="flex items-center justify-center bg-[#3beb53] text-black font-semibold rounded-xl px-4 py-2 mb-7 w-full text-lg placeholder:text-base">
          Sign in as User
        </Link>
      </div>
    </div>
